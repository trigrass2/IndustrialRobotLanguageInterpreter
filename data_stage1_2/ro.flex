...
{integer}               {data_yylval.ID=strdup(yytext); return integer_token;}
{real}		        {data_yylval.ID=strdup(yytext); return real_token;}
{binary_integer}	{data_yylval.ID=strdup(yytext); return binary_integer_token;}
{octal_integer} 	{data_yylval.ID=strdup(yytext); return octal_integer_token;}
{hex_integer} 		{data_yylval.ID=strdup(yytext); return hex_integer_token;}

	/*******************************/
	/* B.1.2.2   Character Strings */
	/*******************************/
{character_string}      {data_yylval.ID=strdup(yytext); return character_string_token;}
